...
impl TextureInstance {
    ...
    pub fn create_storage_texture(device: &wgpu::Device, size: u32, label: &str) -> Self {
        let texture_size = wgpu::Extent3d {
            width: size,
            height: size,
            depth_or_array_layers: 1,
    ...
    pub fn create_texture(device: &wgpu::Device, size: u32, label: &str) -> Self {
        let texture_size = wgpu::Extent3d {
            width: size,
            height: size,
            depth_or_array_layers: 1,
    ...
    pub fn create_cascade_array_texture(device: &wgpu::Device, size: u32, label: &str) -> Self {
        let texture_size = wgpu::Extent3d {
            width: size,
            height: size,
            depth_or_array_layers: 6,
